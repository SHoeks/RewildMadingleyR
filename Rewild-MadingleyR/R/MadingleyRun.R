MadingleyRun = function(out_dir=tempdir(),
                         madingley_data,
                         years=1,
                         ...
                         dispersal_off=F,
                         silenced=F,
                         threshold_prey_density_per_hectare=0,
                         threshold_prey_body_mass_kg=0,
                         n_autotroph_bins=4,
                         large_cohort_higher_sample_prob=F,
                         parallel=T,
                         cohort_output_bins = c(0.0001,0.0010,0.0100,0.1000,1.0000,10.0000,100.0000,1000.0000,10000.0000)) {

  grid_size=0
  MinPreyDensityMaxBodyMassAff_G = threshold_prey_body_mass_kg * 1000
  ...
  writeCohortOutputBins(out_dir,cohort_output_bins)
  ...
  switch(Sys.info()[['sysname']],
    ...
    Windows= {
      ...
      exec_args = paste(spatial_window,'"%PATH1%"',
                        ...
                        '"%PATH3%"','"%PATH4%"',
                        start_t,'"%PATH5%"',
                        grid_size,threshold_prey_density_per_hectare,MinPreyDensityMaxBodyMassAff_G,n_autotroph_bins,
    ...
    Linux  = {
      ...
      exec_args = paste(spatial_window,
                        ...
                        paste0('\"',gsub("\\\\", "/", sp_dir),'\"'),
                        grid_size,
                        threshold_prey_density_per_hectare,
                        MinPreyDensityMaxBodyMassAff_G,
                        n_autotroph_bins,
                        NoDispersal,
                        int_RunInParallel,
                        model_params)
